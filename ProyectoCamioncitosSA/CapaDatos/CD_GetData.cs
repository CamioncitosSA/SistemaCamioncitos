...
namespace CapaDatos
{
    public class CD_GetData
    {
        ...
        public string ConsultarDisponibilidadChofer(int choferId)
        {
            ...
            // Agregar parámetro de salida para almacenar la disponibilidad
            SqlParameter outputParam = new SqlParameter("@DisponibilidadC", SqlDbType.VarChar, 1);
            outputParam.Direction = ParameterDirection.Output;
            cmd.Parameters.Add(outputParam);
            ...
            // Obtener el valor del parámetro de salida
            string disponibilidad = cmd.Parameters["@DisponibilidadC"].Value.ToString();
